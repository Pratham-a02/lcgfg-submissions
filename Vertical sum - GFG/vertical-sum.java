    ...
    public ArrayList<Integer> verticalSum(Node root){
        ...
        while(qu.size()>0){
            ...
            if(hm.containsKey(rem.hd)){
                hm.put(rem.hd,hm.get(rem.hd)+rem.node.data);
            }
            else{
            ...
            if(rem.node.left != null){
                qu.add(new Pair(rem.hd-1,rem.vd+1,rem.node.left));
            }
            if(rem.node.right != null){
                qu.add(new Pair(rem.hd+1,rem.vd+1,rem.node.right));
            }
        }
